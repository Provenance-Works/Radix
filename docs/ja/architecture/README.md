...
| 判断 | 概要 | ADR |
|----------|---------|-----|
| 3層アーキテクチャ | 検証済みコードの最大化、信頼コードの最小化 | [ADR-001](../../spec/adr/0001-three-layer-architecture.md) |
| Mathlib BitVec の採用 | `BitVec n` を仕様レベルの正準表現として使用 | [ADR-002](../../spec/adr/0002-build-on-mathlib-bitvec.md) |
| 2の補数による符号付き整数 | 符号なし型をラップし、MSBを符号として解釈 | [ADR-003](../../spec/adr/0003-signed-integers-twos-complement.md) |
